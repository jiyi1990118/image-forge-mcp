...
realEsrganModel: enum (optional, default: auto) — auto|realesrgan-x4plus|realesrgan-x4plus-anime|realesr-animevideov3. auto selects realesr-animevideov3 for default generated images, stylized prompts (anime/manga/cartoon/illustration/painting/digital art), soft watercolor/ink/brush prompts, and asset/icon/item/sprite/weapon/equipment prompts by default; realesrgan-x4plus-anime only when those asset-style prompts also explicitly mention upscaling/enlarging/super-resolution; and realesrgan-x4plus only for strong photo prompts (photo/photograph/realistic/photorealistic/camera/DSLR/lens). portrait is treated as composition, not a photo signal.
...
→ Do NOT use. Use generateImageUrl instead.`,
  inputSchema: {
    ...
    properties: {
      ...
      realEsrganModel: { type: 'string', default: 'auto', enum: ['auto', 'realesrgan-x4plus', 'realesrgan-x4plus-anime', 'realesr-animevideov3'], description: 'Real-ESRGAN model for generated-image enhancement. auto selects animevideov3 for default generated images, stylized prompts (anime/manga/cartoon/illustration/painting/digital art), soft watercolor/ink/brush prompts, and asset/icon/item/sprite/weapon/equipment prompts by default; anime x4plus only when those asset-style prompts also explicitly mention upscaling/enlarging/super-resolution; and x4plus only for strong photo prompts (photo/photograph/realistic/photorealistic/camera/DSLR/lens). portrait is composition, not a photo signal. Explicit model values override auto selection.' },
